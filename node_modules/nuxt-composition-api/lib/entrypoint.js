...
export { computed, createComponent, createElement, getCurrentInstance, inject, isReactive, isRef, markRaw, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onServerPrefetch, onUnmounted, onUpdated, provide, reactive, ref, set, shallowReactive, shallowRef, toRaw, toRef, toRefs, triggerRef, unref, watch, watchEffect } from '@vue/composition-api';
...
async function writeFile(key) {
    ...
    try {
        writeFileSync(join(staticPath, `${key}.json`), JSON.stringify(staticCache[key]));
    }
    catch (e) {
        console.log(e);
    }
